...
# Коды тем совпадают с колонкой Тема_код в листе «Вопросы по темам»
# и с названиями вкладок в Google Doc теории.
# Порядок должен совпадать с порядком тем в SUBTOPICS.
SUBTOPIC_CODES = {
    "1": ["1_1", "1_2"],
    "2": ["2_1", "2_2", "2_3_4", "2_5", "2_6", "2_7", "2_8"],  # темы 3+4 → одна кнопка 2_3_4
    "3": ["3_1", "3_2", "3_3", "3_4", "3_5", "3_6", "3_7", "3_8", "3_9"],
    "4": ["4_1", "4_2_3", "4_4_5", "4_6", "4_7", "4_8_9"],  # 2+3→4_2_3, 4+5→4_4_5, 8+9→4_8_9
    "5": ["5_1", "5_2", "5_3", "5_4", "5_5", "5_6", "5_7", "5_8", "5_9"],  # 6+7 слиты, 10+11 слиты в 9
    "6": ["6_1", "6_2", "6_3", "6_4", "6_5", "6_6", "6_7", "6_8", "6_9_10"],  # 9+10 → 6_9_10
...
SUBTOPICS = {
    "1": [
        ...
        "Древнейшие верования. Искусство. Особенности древнейших цивилизаций. Заселение территории Беларуси",
    ],
    "2": [
        "Европейское общество в Раннем и Высоком средневековье",
        "Политическое и социальное развитие государств Азии в период Раннего и Высокого средневековья",
        "Славянская миграция. Древняя Русь – государство восточных славян",
        "Первые государства на территории Беларуси",
        "Борьба с внешними завоевателями",
        "Общество и экономика в IX–XIII вв.",
        "Распространение христианства. Культура Беларуси в IX–XIII вв.",
    ],
    "3": [
        "Основные тенденции политического развития цивилизаций в Позднем средневековье",
        "Социально-экономическое развитие цивилизаций в Позднем средневековье",
        "Духовное развитие цивилизаций в Позднем средневековье",
        "Образование ВКЛ",
        "Государственный строй и система управления",
        "Внешняя политика Великого Княжества Литовского",
        "Развитие феодальных отношений, сельского хозяйства, городов, ремесла",
        "Религиозная жизнь. Культура",
        "Формирование белорусской народности",
    ],
    "4": [
        "Основные тенденции политического, социально-экономического и духовного развития цивилизаций в XVI–XVIII вв.",
        "Политическое развитие Беларуси в XVI–XVIII вв. Беларусь в европейских войнах",
        "Экономическое положение Беларуси в XVI — первой половине XVII в.",
        "Реформация. Религиозные войны в Западной Европе. Контрреформация",
        "Конфессиональная ситуация в Беларуси во второй половине XVI — XVIII в.",
        "Гуманизм и Возрождение. Образование и наука в Беларуси",
    ],
    "5": [
        ...
        "Беларусь на пути к индустриальному обществу. Социальные последствия промышленной революции",
        "Общественно-политические движения в XIX — начале XX в.",
        "От белорусской народности к белорусской нации. Белорусское общество в начале XX в.",
        "Культура Беларуси XIX — начала XX в.",
        "Первая мировая война и Беларусь",
    ],
    "6": [
        ...
        "Великая Отечественная война. Беларусь в Великой Отечественной войне",
    ],
    "7": [
